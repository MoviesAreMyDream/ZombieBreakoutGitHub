...
public class vp_SimpleHUD : MonoBehaviour
{
	...
	private GameObject rankNum;
	private GameObject rankWord;
	...
	string FormattedHealth
	{
		...
		get
		{
			...
			if(m_FormattedHealth < 1.0f){
				...
				m_Player.Dead.Active = true;
				rankNum.GetComponent<CustomText>().fontSize = 220;
				rankWord.GetComponent<CustomText>().fontSize = 64;
